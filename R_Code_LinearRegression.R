getwd()
setwd("C:/Users/Yunke/Downloads/4155")
redwine = read.csv(file="winequality-red.csv", header=TRUE,sep=';')
str(redwine)

# set.seed() can make random sample to be the same for every time run code
set.seed(1)
...
#We won't be making a dummy variable for "Poor" and will instead leave that as our “baseline”
